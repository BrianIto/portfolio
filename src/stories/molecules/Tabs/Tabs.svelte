...
<div class="flex gap-2 rounded-lg bg-[#393939] p-2 text-white">
	{#each options as option, i}
		<button
			data-testid={'tab-' + i}
			onclick={() => (indexSelected = i)}
			class={[
				'cursor-pointer rounded-lg px-5 py-2 font-sans text-sm font-bold uppercase duration-200 hover:bg-zinc-600',
